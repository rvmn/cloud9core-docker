...
RUN wget https://raw.githubusercontent.com/rvmn/cloud9core-docker/master/docker-aliases && chmod +x docker-aliases && cat ./docker-aliases >> ~/.bashrc && /bin/bash -c 'source ~/.bashrc'
